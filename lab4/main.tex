...
\subsection{Эмпирическая функция распределения}
	\begin{figure}[H]
	\centering
	{\includegraphics[scale=0.51]{GAUSS.png}}
		\caption{Нормальное распределение} 
		\label{fig:normal}
	\end{figure}
	
\begin{figure}[H]
	{\includegraphics[scale=0.51]{LAPLACE.png}}
		\caption{распределение Лапласа} 
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{CAUCHY.png}}
		\caption{распределение Коши} 
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{UNIFORM.png}}
		\caption{Равномерное распределение} 
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{POISSON.png}}
...
\begin{figure}[H]
	{\includegraphics[scale=0.51]{CAUCHY_KDE_20.png}}
		\caption{распределение Коши, n=20} 
		\label{fig:normal}
	\end{figure}
	
\begin{figure}[H]
	{\includegraphics[scale=0.51]{CAUCHY_KDE_60.png}}
		\caption{распределение Коши, n=60} 
		\label{fig:normal}
	\end{figure}
	
\begin{figure}[H]
	{\includegraphics[scale=0.51]{CAUCHY_KDE_100.png}}
...
\begin{figure}[H]
	{\includegraphics[scale=0.51]{GAUSS_KDE_20.png}}
		\caption{Нормальное распределение, n=20} 
		\label{fig:normal}
	\end{figure}
	
\begin{figure}[H]
	{\includegraphics[scale=0.51]{GAUSS_KDE_60.png}}
		\caption{Нормальное распределение, n=60} 
		\label{fig:normal}
	\end{figure}
		
\begin{figure}[H]
	{\includegraphics[scale=0.51]{GAUSS_KDE_100.png}}
...
\begin{figure}[H]
	{\includegraphics[scale=0.51]{LAPLACE_KDE_20.png}}
		\caption{распределение Лапласа, n=20} 
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{LAPLACE_KDE_60.png}}
		\caption{распределение Лапласа, n=60} 
		\label{fig:normal}
	\end{figure}
		
\begin{figure}[H]
	{\includegraphics[scale=0.51]{LAPLACE_KDE_100.png}}
		\caption{распределение Лапласа, n=100} 
		\label{fig:normal}
	\end{figure}
		
\begin{figure}[H]
	{\includegraphics[scale=0.51]{POISSON_KDE_20.png}}
		\caption{распределение Пуассона, n=20} 
		\label{fig:normal}
	\end{figure}
	
\begin{figure}[H]
	{\includegraphics[scale=0.51]{POISSON_KDE_60.png}}
		\caption{распределение Пуассона, n=60} 
		\label{fig:normal}
	\end{figure}
	
\begin{figure}[H]
	{\includegraphics[scale=0.51]{POISSON_KDE_100.png}}
		\caption{распределение Пуассона, n=100} 
		\label{fig:normal}
	\end{figure}
	
\begin{figure}[H]
	{\includegraphics[scale=0.51]{UNIFORM_KDE_20.png}}
		\caption{Равномерное распределение, n=20} 
		\label{fig:normal}
	\end{figure}
	
\begin{figure}[H]
	{\includegraphics[scale=0.51]{UNIFORM_KDE_60.png}}
		\caption{Равномерное распределение, n=60} 
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{UNIFORM_KDE_100.png}}
